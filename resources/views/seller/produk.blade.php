                                ...
                                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex gap-2 mt-2.5">
                                            ...
                                            <form id="delete-form-mobile-{{ $produk->id }}" action="{{ route('produk.destroy', $produk->id) }}" method="POST">
                                                @csrf @method('DELETE')
                                                <button type="button"
                                                    onclick="openDeleteModal('{{ route('produk.destroy', $produk->id) }}', 'Hapus Produk?', 'Produk \'{{ addslashes($produk->nama_produk) }}\' akan dihapus permanen.')"
                                                    title="Hapus"
